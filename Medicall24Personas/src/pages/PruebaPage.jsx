...
// import Modal from "../components/modals/isRegisteredFree";
...
//   return (
//         <div className="relative w-full max-w-5xl mx-auto bg-white p-6 h-auto shadow-md rounded-md" onChange={() => setIsDirty(true)}  >
...
//               onClick={isUserRegistered ? nextStep : OpenTerm}
//               disabled={!isUserRegistered}
//             >
//               {isUserRegistered ? "Siguiente" : "Registrarse"}
//             </button>
//           ) : currentStep === 2 ? (
//             <button
//               className="w-auto px-4 py-2 bg-pink-600 text-white font-semibold rounded-lg hover:bg-orange-500 focus:outline-none focus:ring-4 focus:ring-pink-600 transition-all disabled:opacity-50"
...
//             <Modal isOpen={modal} onClose={modalCloseIsRegistered} />
//             <ModalNotRegistered 
//               status={status} 
//               isOpen={isModalOpen} 
