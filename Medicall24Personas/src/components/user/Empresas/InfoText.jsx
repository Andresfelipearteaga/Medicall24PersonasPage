...
<div className="container mx-auto flex flex-row md:flex-col sm:flex-col items-center justify-center gap-8">
  <div className="w-full md:w-2/2 text-left md:text-center">
    <h1 className="text-5xl md:text-3xl font-bold leading-tight md:leading-normal">
      <span className="font-bold bg-gradient-to-r from-pink-600 via-orange-500 to-pink-500 bg-clip-text text-transparent">Acceso rápido</span> <span className="text-gray-600">a la salud sin salir del trabajo</span>
       ...
       <p className="mt-4 md:mt-0 font-regular text-gray-600">
  ...
  <div className="w-full md:w-2/3 rounded-3xl overflow-hidden">
